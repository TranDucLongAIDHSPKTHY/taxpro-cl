...
ROWS = [
    ...
    ("§5.5", "Prototype-construction variants (leaf_uniform, leave_one_out, rescue) vs. V3: Overall/Warm exclude zero (improving) for all 3; leave_one_out alone excludes zero on Near-Cold", "amazon-book", "leaf_uniform/leave_one_out/rescue vs. V3 (and rescue vs. V0)", "Recall@20 diff., bootstrap CI", "all 4 groups", "Table S17", "per-user bootstrap CI, pooled 3 seeds", "tools/analysis/leaf_variants_bootstrap.py, rescue_vs_variants_bootstrap.py"),
