"""Build taxonomy variants + evaluation protocol for cds-and-vinyl.
...
ROOT_CATEGORY = "CDs & Vinyl"
CATALOG_ITEMS = None  # set from item_list.txt at runtime, see main()
VERIFY_DIR = ROOT / "dataset_verify" / DATASET_NAME
MAPPING_PATH = ROOT / "metadata" / "item2category_cds_and_vinyl.json"
MERGED_PATH = ROOT / "metadata" / "merged_metadata_cds_and_vinyl.json"
...
def build_cds_and_vinyl_taxonomy_variants(degrees, catalog_items):
    ...
    for threshold in THRESHOLDS:
        ...
        policy = {
            ...
            "root_only_cds_and_vinyl_prototype": False,
...
def main():
    ...
    variant_results = build_cds_and_vinyl_taxonomy_variants(degrees, catalog_items)
